...
# dataset -----------------------
_C.DATA.BASEDIR = r'/media/aman/DRIVE2/CAR/MappiliaryDataset/coco_format_car'
...
# backbone ----------------------
_C.BACKBONE.WEIGHTS = r'/media/aman/DRIVE2/CAR/FasterRCNN/ImageNet-R50-AlignPadding.npz'
...
_C.BACKBONE.FREEZE_AT = 1 #2  # options: 0, 1, 2. How many stages in backbone to freeze (not training)
...
_C.TRAIN.EVAL_PERIOD = 5  # period (epochs) to run evaluation
_C.TRAIN.CHECKPOINT_PERIOD = 1  # period (epochs) to save model

# preprocessing --------------------
# Alternative old (worse & faster) setting: 600
_C.PREPROC.TRAIN_SHORT_EDGE_SIZE = [416, 416]  # [min, max] to sample from
_C.PREPROC.TEST_SHORT_EDGE_SIZE = 416
_C.PREPROC.MAX_SIZE = 640
