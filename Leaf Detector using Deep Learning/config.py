...
# dataset -----------------------
_C.DATA.BASEDIR = 'coco_format_dataset' 
...
_C.DATA.NUM_WORKERS = 5 #10

# backbone ----------------------
_C.BACKBONE.WEIGHTS = 'ImageNet-R101-AlignPadding.npz'  #''
...
_C.TRAIN.STEPS_PER_EPOCH = 1000 #100 #5000
...
_C.TRAIN.EVAL_PERIOD = 5 ##50  # period (epochs) to run evaluation
